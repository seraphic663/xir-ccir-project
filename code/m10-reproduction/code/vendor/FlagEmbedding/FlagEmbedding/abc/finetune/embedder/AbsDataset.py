...
class AbsEmbedderSameDatasetTrainDataset(AbsEmbedderTrainDataset):
    ...
    def __getitem__(self, _):
        ...
        self.step += 1
        queries, passages, teacher_scores, reweight_rates = self._create_batch_data(batch_raw_data=batch_data)
        return queries, passages, teacher_scores, reweight_rates, no_in_batch_neg_flag
    ...
    def _create_batch_data(self, batch_raw_data):
        ...
        return queries, passages, teacher_scores, reweight_rates
